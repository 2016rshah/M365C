...
\begin{document}
	...
	\section{}
		...
		\end{em}
			...
			% Since $f_n \to f$ in the sup norm we know that $\norm{f_n(x) - f(x)}_\infty \to 0$. This means that $sup_{x \in [a, b]}|f_n(x) - f(x)| \to 0$. Thus for any $\varepsilon \geq$, there is some $N$ such that $\forall n \geq N\ .\ sup_{x \in [a, b]}|f_n(x) - f(x)| \leq \varepsilon$. This implies that $f_n(x) - f(x) \leq \varepsilon$ for all $x \in [a, b]$. 
